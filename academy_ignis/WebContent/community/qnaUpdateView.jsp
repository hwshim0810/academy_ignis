...
<div class="wrapper">
	<div class="container">
		...
		<div class="col-xs-12 col-sm-9 col-md-10 ">
			...
			<form alt="qnaUpdate" method="post"
				action="./qnaUpdate?pagenum=<%=pagenum%>&qb_num=<%=list.get(0).getQb_num()%>">
				<div class="form-group">
					<label for="qb_title">제목:</label> <input type="text"
						class="form-control" name="qb_title"
						value="<%=list.get(0).getQb_title()%>" />
				</div>
				<div class="form-group">
