...
<table class="table table-responsive" style="text-align : center;">
	...
	<tr>
		...
		<td style="text-align : left;">
			<a href="/academy_ignis/EventView?login=admin&pageNo=<%= pageLink %>&num=<%= event.getEb_num()%> ">
				<%= event.getEb_title() %>
			</a>
		</td>
...
<script type="text/javascript" charset="utf-8" src="/academy_ignis/script/search_event_page.js"></script>