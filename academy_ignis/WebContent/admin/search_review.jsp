...
<table class="table">
	...
	%>
		<tr>
			...
			<td>
				<a href="/academy_ignis/ReviewView?login=admin&pageNo=<%= pageLink %>&num=<%= review.getRb_num()%>&commPageNo=<%= commPageNo%>"><%= review.getRb_title() %></a>
...
<script type="text/javascript" charset="utf-8" src="/academy_ignis/script/search_review_page.js"></script>