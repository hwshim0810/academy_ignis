	...
	<table class='table'>
		...
		<thead>
			<tr>
				...
				<th class="hidden-xs hidden-sm">생일</th>
				<th class="hidden-xs hidden-sm">주소</th>
				<th class="hidden-xs hidden-sm">휴대폰번호</th>
				<th class="hidden-xs hidden-sm">Email</th>
				<th class="hidden-xs hidden-sm">가입일</th>
				<th></th>
			</tr>
		</thead>
		<tbody>
		...
		<tr>
			<td><%=user.getM_id() %></td>
			<td class="hidden-xs hidden-sm"><%=user.getM_name() %></td>
			<td class="hidden-xs hidden-sm"><%=user.getM_birth() %></td>
			<td class="hidden-xs hidden-sm"><%=user.getM_addr() %></td>
			<td class="hidden-xs hidden-sm"><%=user.getM_phone() %></td>
			<td class="hidden-xs hidden-sm"><%=user.getM_email() %></td>
			<td class="hidden-xs hidden-sm"><%=user.getM_enterdate() %></td>
			<td><a href="/academy_ignis/adMyPage?userId=<%=user.getM_id()%>">보기</a></td>
		</tr>
		<%
				}
			} else {
